            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    <ul class="list-unstyled list-inline">
                        <li><i class="fa fa-phone"></i><span>+972-524380096</span></li>
          ...
          <ul>
            <!--<li class="dropdown">-->
              ...
              <!--<ul class="dropdown-menu">-->
                <!--<li class="active"><a href="index.php">Home Default</a></li>-->
            ...
            <!--<li class="dropdown">-->
              ...
              <!--<ul class="dropdown-menu">-->
                ...
                <!--<li><a href="page-reg-page.php">Signup Page</a></li>-->
          ...
          <ul id="revolutionul">
            ...
            <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="../../assets/frontend/pages/img/revolutionslider/thumbs/thumb2.jpg">
              ...
              <div class="caption lft slide_title slide_item_left"
                ...
                data-start="1500"
                data-easing="easeOutExpo">
                Interested in going to multiple
                <br>
    ...
    <div class="main">
      <div class="container">
        ...
        <!--<div class="row recent-work margin-bottom-40">-->
          <!--<div class="col-md-3">-->
            <!--<h2><a href="portfolio.php">Recent Works</a></h2>-->
            ...
            <!--<div class="owl-carousel owl-carousel3">-->
              <!--<div class="recent-work-item">-->
                <!--<em>-->
                  ...
                  <!--<a href="portfolio-item.php"><i class="fa fa-link"></i></a>-->
        ...
        <!--</div>                -->
        <!--&lt;!&ndash; END TABS AND TESTIMONIALS &ndash;&gt;-->
