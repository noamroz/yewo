...
<head>
  <meta charset="utf-8">
  <title>Create new company account | Metronic Frontend</title>
      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-9 col-sm-9">
            <h1>Create a Company's account</h1>
            <div class="content-form-page">
              <div class="row">
                <div class="col-md-7 col-sm-7">
                  <form class="form-horizontal" role="form" method="post"
                  action="https://yewo.herokuapp.com/service.php?format=json&method=signup&action=1">

                    <fieldset>
                      <legend>Enter your company details</legend>
                      <div class="form-group">
                        <label for="firstname" class="col-lg-4 control-label">Company Name<span class="require">*</span></label>
                        <div class="col-lg-8">
                      ...
                      <div class="form-group">
                        <label for="linkedin" class="col-lg-4 control-label">website<span class="require">*</span></label>
                        <div class="col-lg-8">
